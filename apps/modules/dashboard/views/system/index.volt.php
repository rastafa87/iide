                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-actions">
                            ...
                            <tbody>
                            <?php foreach ($allcountry as $values) { ?>
                            <tr id="<?= $values->getCoid() ?>">
                                <td><?= $values->getCountry() ?></td>
                                <td><?= $values->getAbbreviation() ?></td>
                                <td>
                                    <a href="<?= $this->url->get('dashboard/system/edit?coid=') ?><?= $values->getCoid() ?>" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                            </tbody>
