            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <ul class="panel-controls">
                        ...
                        <li><a href="<?= $this->url->get('dashboard/system/new?coid=' . $country->getCoid()) ?>" class=""><span class="fa fa-plus"></span></a></li>
                            ...
                            <tbody>
                                ...
                                <tr class="<?= $values->getLaid() ?>">
                                    ...
                                    <td class="options" data-id="<?= $values->getLaid() ?>">
                                        <a href="<?= $this->url->get('dashboard/system/editlaw?laid=' . $values->getLaid() . '&coid=' . $country->getCoid()) ?>" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                        &nbsp;
