            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <ul class="panel-controls">
                        <li><a href="{{url('dashboard/area/new')}}"><span class="fa fa-plus"></span></a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-actions">
                            ...
                            <tr id="{{values.getAreid()}}">
                                ...
                                <td>
                                    <a href="{{url('dashboard/area/edit?areid=')}}{{values.getAreid()}}" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                </td>
                            </tr>
                            {% endfor %}
                            </tbody>
