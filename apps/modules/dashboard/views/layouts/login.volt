...
<head>
    <!-- META SECTION -->
    <title>IIDE | Login</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />

    <!--Meta Google-->
    <meta name="description" content="C-Developers crea Paginas web en Villahermosa Tabasco, desarrollo web en el Sureste de México y toda la republica mexicana ademas Marketing y SEO" />
    <meta name="keywords" content="desarrollo,paginas,web,villahermosa,Tabasco,developers,software,altruista,publicidad,sistemas,programacion,mexico,barato,calidad,caro,rapido,creacion,region,sur,sureste" />
    ...
    <link rel="canonical" href="http://c-developers.com/" />
    <!--Meta Facebook -->
    <meta property="og:title" content="Chontal Developers | Login"/>
    <meta property="og:type" content="web"/>
    <meta property="og:url" content="http://c-developers.com/"/>
...
{{ content() }}
    ...
    <script src="{{url('dash/js/custom2.js')}}"></script>
</body>
</html>