        ...
        <div class="page-sidebar">
            ...
            <ul class="x-navigation">
                ...
                <li class="xn-openable <?= $this->router->getControllerName() && ($this->router->getActionName()=='newnote' || $this->router->getActionName()=='index')=='notes'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='newnote'?"active":""?>"><a href="{{url('dashboard/notes/new-note')}}"><span class="fa fa-pencil"></span> Nueva nota</a></li>
                        <li class="<?php echo $this->router->getActionName()=='index'?"active":""?>"><a href="{{url('dashboard/notes')}}"><span class="fa fa-file"></span> Todas las notas</a></li>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='system'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='index'?"active":""?>"><a href="{{url('dashboard/paises')}}"><span class="fa fa-file"></span> Todo los paises</a></li>
                    </ul>
                </li>
                <li class="xn-openable <?php echo $this->router->getControllerName()=='investigador'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='new'?"active":""?>"><a href="{{url('dashboard/investigador/new')}}"><span class="fa fa-pencil"></span> Nuevo investigador</a></li>
                        <li class="<?php echo $this->router->getActionName()=='index'?"active":""?>"><a href="{{url('dashboard/investigador')}}"><span class="fa fa-file"></span> Todo los investigadores</a></li>
                    </ul>
                </li>
                <li class="xn-openable <?= $this->router->getControllerName()=='notes' && ($this->router->getActionName()=='conferencias'|| $this->router->getActionName()=='newcurso' || $this->router->getActionName()=='talleres'|| $this->router->getActionName()=='diplomados'|| $this->router->getActionName()=='foros'|| $this->router->getActionName()=='Seminarios')?"active":""?>">
                    ...
                    <ul>
                        <li><a href="{{url('dashboard/notes/new-curso')}}"><span class="fa fa-align-justify"></span>Nuevo Curso</a></li>
                        <li><a href="{{url('dashboard/notes/conferencias')}}"><span class="fa fa-align-justify"></span> Conferencias</a></li>
                        <li><a href="{{url('dashboard/notes/talleres')}}"><span class="fa fa-align-justify"></span> Talleres</a></li>
                        <li><a href="{{url('dashboard/notes/diplomados')}}"><span class="fa fa-align-justify"></span> Diplomados</a></li>
                        <li><a href="{{url('dashboard/notes/foros')}}"><span class="fa fa-align-justify"></span> Foros</a></li>
                        <li><a href="{{url('dashboard/notes/seminarios')}}"><span class="fa fa-align-justify"></span> Seminarios</a></li>
                    </ul>
                </li>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='user'?"active":""?>">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{url('dashboard/users')}}"><span class="fa fa-user"></span> Activos</a>
                        </li>
                        <li>
                            <a href="{{url('dashboard/user/inactivos')}}"><span class="fa fa-user-times"></span> Inactivos</a>
                        </li>
                    </ul>
                </li>
                <li class="xn-openable <?php echo $this->router->getControllerName()=='area'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='index'?"active":""?>">
                            <a href="{{url('dashboard/area/index')}}"><span class="fa fa-user-plus"></span>Area</a>
                        </li>
