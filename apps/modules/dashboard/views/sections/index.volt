...
<div class="page-title">
    <h2><a href="{{url('dashboard')}}"><span class="fa fa-arrow-circle-o-left"></span> Salir</a></h2>
</div>
<!-- END PAGE TITLE -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-heading">
                <h3 class="panel-title">Configuración sección {{category}}</h3>
            </div>
            ...
            <span class="hide" id="category" data-value="{{category}}"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <select name="principalNew" id="ajax-post" class="form-control">
                                            {% if(!findNew is empty)%}
                                                <option value="{{findNew.getPid()}}" selected>{{findNew.getTitle()}}</option>
                                                <input type="hidden" name="pidLast" id="pidLast" value="{{findNew.getPid()}}"/>
                                            {% endif %}
                                        </select>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <select name="SliderNew[]" id="ajax-post-slider-1" class="form-control" data-order="1"/>
                                            {% if(!slider is empty)%}
                                                <option value="{{slider[1]['pid']}}" selected>{{slider[1]['title']}}</option>
                                            {% endif %}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <select name="SliderNew[]" id="ajax-post-slider-2" class="form-control" data-order="2"/>
                                            {% if(!slider is empty)%}
                                                <option value="{{slider[2]['pid']}}" selected>{{slider[2]['title']}}</option>
                                            {% endif %}
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <select name="SliderNew[]" id="ajax-post-slider-3" class="form-control" data-order="3"/>
                                            {% if(!slider is empty)%}
                                                <option value="{{slider[3]['pid']}}" selected>{{slider[3]['title']}}</option>
                                            {% endif %}
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <select name="SliderNew[]" id="ajax-post-slider-4" class="form-control" data-order="4"/>
                                            {% if(!slider is empty)%}
                                                <option value="{{slider[4]['pid']}}" selected>{{slider[4]['title']}}</option>
                                            {% endif %}
                                        </select>
                                        {% if(!slider is empty)%}
                                            <input type="hidden"  name="pidLast[]" id="pdi1" value="{{slider[1]['pid']}}"/>
                                            <input type="hidden"  name="pidLast[]" id="pdi2" value="{{slider[2]['pid']}}"/>
                                            <input type="hidden"  name="pidLast[]" id="pdi3" value="{{slider[3]['pid']}}"/>
                                            <input type="hidden"  name="pidLast[]" id="pdi4" value="{{slider[4]['pid']}}"/>
                                        {% else %}
