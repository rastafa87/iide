    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-body profile" style="background: url('<?= $this->url->get('acms/assets/images/gallery/music-4.jpg') ?>') center center no-repeat;">
                ...
                <div class="panel-body list-group border-bottom">
                    ...
                    <a href="<?= $this->url->get('dashboard/users/edit/' . $user->getUid()) ?>" class="list-group-item"><span class="fa fa-cog"></span> Administración editar</a>
                </div>
            </div>
        </div>
        <?php endforeach;?>
