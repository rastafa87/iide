                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-actions datatable">
                            ...
                            <tbody>
                            <?php foreach ($allnotes as $values) { ?>
                            <?php
                            ...
                            <tr id="<?= $values->getPid() ?>">
                                ...
                                <td><?= $newDate ?></td>
                                <td>
                                    <a href="<?= $this->url->get('dashboard/notes/edit-curso?pid=') ?><?= $values->getPid() ?>" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
