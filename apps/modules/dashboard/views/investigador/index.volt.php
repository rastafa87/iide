                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-actions ">
                            ...
                            <tbody>
                            <?php foreach ($investigadores as $values) { ?>
                            <tr id="<?= $values->getInveid() ?>">
                                ...
                                <td>
                                    <a href="<?= $this->url->get('dashboard/investigador/edit?inveid=') ?><?= $values->getInveid() ?>" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
